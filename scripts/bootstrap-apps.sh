...
function apply_configmaps() {
    ...
    local -r configmaps=(
        "${ROOT_DIR}/kubernetes/flux/components/common/cluster-settings.yaml"
    )
...
function apply_sops_secrets() {
    ...
    local -r secrets=(
        ...
        "${ROOT_DIR}/kubernetes/flux/components/common/cluster-secrets.sops.yaml"
        "${ROOT_DIR}/kubernetes/flux/components/common/sops-age.sops.yaml"
    )
